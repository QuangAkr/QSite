				...
				<table class="table table-hover table-bordered">
					...
					<?php foreach ($arr as $rows){ ?>
						...
						<td style="text-align: center;">
							<a href="admin.php?controller=add_edit_category_product&act=edit&id=<?php echo $rows->pk_category_product_id; ?>">Sửa</a>&nbsp;&nbsp;&nbsp;
							<a onclick=" return window.confirm('Bạn có muốn xóa k ???')" href="admin.php?controller=add_edit_category_product&act=delete&id=<?php echo $rows->pk_category_product_id; ?>">Xóa</a>
