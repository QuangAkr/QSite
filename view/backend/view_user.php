				...
				<table class="table table-hover table-bordered">
					...
					<?php foreach ($arr as $rows){ ?>
						...
						<td style="text-align: center;">
							<a href="admin.php?controller=add_edit_user&act=edit&id=<?php echo $rows->pk_user_id; ?>">Sửa</a>&nbsp;&nbsp;&nbsp;
							<a onclick=" return window.confirm('Bạn có muốn xóa k ???')" href="admin.php?controller=add_edit_user&act=delete&id=<?php echo $rows->pk_user_id; ?>">Xóa</a>
