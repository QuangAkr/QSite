			...
			<div class="card card-header bg-primary text-white" style="padding:7px !important;">News</div>
				...
				<table class="table table-hover table-bordered">
					...
					<tr>
						...
						<td align="center">
							<?php 
								// lấy tên danh mục tại tbl_category_news
						...
						<td style="text-align: center;">
							<a href="admin.php?controller=add_edit_news&act=edit&id=<?php echo $rows->pk_news_id; ?>">Sửa</a>&nbsp;&nbsp;&nbsp;
							<a onclick=" return window.confirm('Bạn có muốn xóa k ???')" href="admin.php?controller=add_edit_news&act=delete&id=<?php echo $rows->pk_news_id; ?>">Xóa</a>
