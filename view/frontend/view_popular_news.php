...
<div class="col-md-6 popular ">
  ...
  <?php for ($i=0; $i < 2; $i++) { ?>
    ...
    <div class="col-md-6 psnelnews"> <img src="public/upload/news/<?php echo $arr[$i]->c_img; ?>">
      <h3><a href="index.php?controller=news_detail&id=<?php echo $arr[$i]->pk_news_id; ?>"><?php echo $arr[$i]->c_name; ?></a></h3>
  ...
  <div class="col-md-12 news">
    ...
    <?php for ($i=2; $i < 5; $i++) { ?>
      ...
      <div class="caption ">
        <div class="row post">
          <h4><a href="index.php?controller=news_detail&id=<?php echo $arr[$i]->pk_news_id; ?>"><?php echo $arr[$i]->c_name; ?></a></h4>
